...
| AC-04 | Important event latency is below the V0 target | Partial | Cross-process event-to-WebSocket smoke is P50 163 ms/P95 287 ms; browser event-to-paint measurement remains pending |
