...
Phase 0 对真实 CLI、进程和平台行为的可复现实验结论。结论必须记录版本、命令、环境、脱敏样例和能力边界。

V1 汇总文档：

- [`../v1-acceptance.md`](../v1-acceptance.md)：能力、平台和发布状态矩阵；
- [`../v1-release-notes.md`](../v1-release-notes.md)：面向用户的 V1 交付内容与限制；
